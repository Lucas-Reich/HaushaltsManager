...
public class CategoryListVer2 extends AbstractAppCompatActivity implements CategoryFABToolbar.OnCategoryFABToolbarMenuItemClicked {
    private static final String TAG = CategoryListVer2.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_list_ver3);
    ...
    private void handleOpenChildClick(Category clickedCategory, Category parent) {
        ...
        if (getCallingActivity() != null) {
            ...
            Intent updateCategoryIntent = new Intent(CategoryListVer2.this, CreateCategory.class);
