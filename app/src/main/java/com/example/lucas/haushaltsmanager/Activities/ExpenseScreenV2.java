...
public class ExpenseScreenV2 extends AbstractAppCompatActivity {
    private static final String TAG = ExpenseScreenV2.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_expense_screen_ver2);
    ...
    protected void onStart() {
        ...
        mCategoryTxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent categoryIntent = new Intent(ExpenseScreenV2.this, CategoryListActivity.class);
        ...
        mAccountTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                accountPicker.createBuilder(ExpenseScreenV2.this);
    ...
    private View.OnClickListener getSaveClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (bundle.getString(INTENT_MODE, INTENT_MODE_CREATE_BOOKING)) {
                    case INTENT_MODE_UPDATE_PARENT:
                        ...
                        try {
                            ...
                            Toast.makeText(ExpenseScreenV2.this, "Updated Booking " + mExpense.getTitle(), Toast.LENGTH_SHORT).show();
                        } catch (ExpenseNotFoundException e) {

                            Toast.makeText(ExpenseScreenV2.this, "Buchung konnte nicht geupdated werden", Toast.LENGTH_SHORT).show();
                    ...
                    case INTENT_MODE_UPDATE_CHILD:
                        ...
                        try {
                            ...
                            Toast.makeText(ExpenseScreenV2.this, "KindBuchung konnte nicht geupdated werden", Toast.LENGTH_SHORT).show();
                            //todo fehlerbehandlung
                            //todo übersetzung
                        }
                        break;
                    case INTENT_MODE_ADD_CHILD:
                        ...
                        try {
                            ...
                            Toast.makeText(ExpenseScreenV2.this, "Added Booking \"" + mExpense.getTitle() + "\" to parent Booking " + mParentBooking.getTitle(), Toast.LENGTH_SHORT).show();
                    ...
                    case INTENT_MODE_CREATE_BOOKING:
                        ...
                        Toast.makeText(ExpenseScreenV2.this, "Created Booking \"" + mExpense.getTitle() + "\"", Toast.LENGTH_SHORT).show();
                        break;
                    default:
                ...
                Intent intent = new Intent(ExpenseScreenV2.this, ParentActivity.class);
