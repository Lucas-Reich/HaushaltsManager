    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addCatFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent createCategoryIntent = new Intent(ShowCategoriesActivity.this, CreateNewCategoryActivity.class);
                ShowCategoriesActivity.this.startActivity(createCategoryIntent);
            }
        });
    }
}
